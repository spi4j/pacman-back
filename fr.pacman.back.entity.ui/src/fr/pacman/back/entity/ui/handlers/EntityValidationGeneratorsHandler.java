...
import fr.pacman.back.entity.ui.generators.EntityValidationUIGenerators;

/**
 * Lanceur pour la demande de validation d'un modèle entity.
 * 
 * @author MINARM
 */
public class EntityValidationGeneratorsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent p_event) throws ExecutionException {
		...
		while (v_iterator.hasNext()) {
			...
			if (v_selected instanceof IFile) {
				new EntityValidationUIGenerators((IFile) v_selected).generate();
			}
		}
		return null;
	}
