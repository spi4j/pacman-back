 ...
 * @author MINARM
 */
public class GenWebapp extends PacmanGeneratorStart {

	@Override
	public String getSubProjectName() {
		return ProjectProperties.get_projectWebappName(null);
	}

	@Override
	public String getModuleQualifiedName() {
		if (ProjectProperties.is_spring(null))
			return "fr::pacman::config::aql::genWebappSpring";
		return "fr::pacman::config::aql::genWebappSpi4j";
	}
