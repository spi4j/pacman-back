package fr.pacman.back.core.convention.rule;

import fr.pacman.back.core.convention.NotationDefinition;
import fr.pacman.back.core.property.PacmanProperty;
import fr.pacman.back.core.property.PropertiesCategory;

/**
 * Classe des règles de nommage sur les parametres. Placer les propriétés dans
 * l'ordre d'affichage désiré dans le fichier.
 *
 * @author MINARM
 */
public class ParameterNamingRule extends PropertiesCategory {
	...
	/**
	 * Appliquer la norme 'parameterMethodClassicIn' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	...
	/**
	 * Appliquer la norme 'parameterMethodMultiple' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	...
	/**
	 * Appliquer la norme 'parameterMethodMultipleMap' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	...
	/**
	 * Appliquer la norme 'parameterMethodObjectIn' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	...
	/**
	 * Appliquer la norme 'parameterMethodClassicOut' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	...
	/**
	 * Appliquer la norme 'parameterMethodObjectOut' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	...
	/**
	 * Appliquer la norme 'parameterMethodClassicInOut' sur la valeur passée en
	 * parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	...
	/**
	 * Appliquer la norme 'parameterMethodReset' sur la valeur passée en parametre.
	 * 
	 * @param p_value     la valeur originale (ex : "montant reel").
	 * @param p_modelFile les properties.
	 * @return La valeur respectant la norme.
