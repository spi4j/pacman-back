package fr.pacman.back.core.enumeration;
...
public enum AnnotationEnum {
	...
	S3_RETENTION("STORAGE_RETENTION",  ModelEnum.DSL_SOA_SERVICE, true),
	
	S3_RETENTION_DATE("STORAGE_RETENTION_DURATION",  ModelEnum.DSL_SOA_SERVICE, true),
