...
/**
 * Générateur pour la couche de service client. Génération de l'ensemble des
 * services.
 * 
...
public class GenServer extends PacmanGenerator {
	...
	public String getModuleQualifiedName() {
		if (ProjectProperties.is_spring(null))
			return "fr::pacman::soaclient::spi4j::aql::genServerSpring";
		return "fr::pacman::soaclient::spi4j::aql::genServerSpi4j";
	}
