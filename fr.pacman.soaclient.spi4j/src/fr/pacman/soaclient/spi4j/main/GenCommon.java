package fr.pacman.soaclient.spi4j.main;
 ...
 * entités et des classes nécessaires pour la gestion de la couche soa client.
 * Ce module est le point d'entrée principal pour la génération en fonction de
 * la technologie demandée (spring, spi4j, etc...).
 * <p>
...
public class GenCommon extends PacmanGenerator {
	...
	public String getModuleQualifiedName() {
		if (ProjectProperties.is_spring(null))
			return "fr::pacman::soaclient::spi4j::aql::genCommonSpring";
		return "fr::pacman::soaclient::spi4j::aql::genCommonSpi4j";
	}
