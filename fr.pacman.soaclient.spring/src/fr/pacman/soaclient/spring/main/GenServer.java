...
/**
 * Générateur pour la couche de service soa client. Génération de l'ensemble des
 * services.
 * <p>
...
public class GenServer extends PacmanGenerator {
	...
	public String getModuleQualifiedName() {
		if (ProjectProperties.is_spring(null))
			return "fr::pacman::soaclient::spring::aql::genServerSpring";
		return "fr::pacman::soaclient::spring::aql::genServerSpi4j";
	}
