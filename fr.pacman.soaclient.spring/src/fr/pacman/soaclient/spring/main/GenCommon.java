package fr.pacman.soaclient.spring.main;
...
/**
 * Générateur pour la couche soa client. Ce module est le point d'entrée
 * principal pour la génération en fonction de la technologie demandée (spring,
 * spi4j, etc...).
 * <p>
...
public class GenCommon extends PacmanGenerator {
	...
	public String getModuleQualifiedName() {
		if (ProjectProperties.is_spring(null))
			return "fr::pacman::soaclient::spring::aql::genCommonSpring";
		return "fr::pacman::soaclient::spring::aql::genCommonSpi4j";
	}
