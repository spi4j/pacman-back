package fr.pacman.back.config.ui.handlers;
...
import fr.pacman.back.config.ui.generators.ConfigUIGenerators;

/**
 * Lanceur pour la demande de génération de la couche configuration à partir
 * d'un fichier de modélisation de type '.soa' ou '.entity'.
 * 
 * @author MINARM
 */
