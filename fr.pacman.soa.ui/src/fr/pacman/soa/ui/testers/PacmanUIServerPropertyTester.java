package fr.pacman.soa.ui.testers;

import fr.pacman.core.property.project.ProjectProperties;
import fr.pacman.core.ui.generator.PacmanUIPropertyTester;
 ...
 * {@code fr.pacman.soaclient.canShowMenu} et permet de contrôler
 ...
 * <pre>{@code
 * <test
 *    property="fr.pacman.soaclient.canShowMenu"
 ...
 */
public class PacmanUIServerPropertyTester extends PacmanUIPropertyTester {

    /**
     * Vérifie si le projet courant est de type "server".
     *
	...
	public boolean testProperty(Object receiver, String property, Object[] args, Object expectedValue) {
		if (ProjectProperties.get_type(null).equals("server"))
			return true;
		return false;
	}
}
