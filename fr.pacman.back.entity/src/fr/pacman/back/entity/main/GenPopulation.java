package fr.pacman.back.entity.main;
...
/**
 * Générateur pour la population de la base données. Ce 'générateur' créé
 * l'ensemble des fichiers nécessaires pour l'insertion des données dans la
 * base.
 * 
...
public class GenPopulation extends PacmanGenerator {
	...
	public String getModuleQualifiedName() {
		return "fr::pacman::back::entity::aql::genPopulation";
	}
